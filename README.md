...
- [Error Registry](#error-registry)
  ...
  - [Instance comparison: `ErrorRegistry:instanceOf(classInstance, highLevelErrorName)`](#instance-comparison-errorregistryinstanceofclassinstance-highlevelerrorname)
- [Error manipulation](#error-manipulation)
  - [Attaching errors: `BaseError#causedBy(err)`](#attaching-errors-baseerrorcausedbyerr)
  - [Format messages: `BaseError#formatMessage(...formatParams)`](#format-messages-baseerrorformatmessageformatparams)
  - [Adding metadata](#adding-metadata)
    - [Safe metadata: `BaseError#withSafeMetadata(data = {})`](#safe-metadata-baseerrorwithsafemetadatadata--)
    - [Internal metadata: `BaseError#withMetadata(data = {})`](#internal-metadata-baseerrorwithmetadatadata--)
- [Serializing errors](#serializing-errors)
  - [Safe serialization: `BaseError#toJSONSafe()`](#safe-serialization-baseerrortojsonsafe)
  - [Internal serialization: `BaseError#toJSON()`](#internal-serialization-baseerrortojson)
...
## Instance comparison: `ErrorRegistry:instanceOf(classInstance, highLevelErrorName)`
...
With the exception of the serialization methods, all methods are chainable.

## Attaching errors: `BaseError#causedBy(err)`
...
## Format messages: `BaseError#formatMessage(...formatParams)`
...
### Safe metadata: `BaseError#withSafeMetadata(data = {})`
...
### Internal metadata: `BaseError#withMetadata(data = {})`
