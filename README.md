...
- [Usage](#usage)
  ...
  - [Attaching errors: `BaseError#causedBy()`](#attaching-errors-baseerrorcausedby)
  - [Fomatting messages: `BaseError#formatMessage()`](#fomatting-messages-baseerrorformatmessage)
